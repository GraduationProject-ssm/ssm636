...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=35)


# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本孩童收养信息管理也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让考试信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，孩童收养信息管理的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，孩童收养信息管理是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
信息数据的处理完全依赖人工进行操作，会耗费大量的人工成本，特别是面对大量的数据信息时，传统人工操作不仅不能对数据的出错率进行保证，还容易出现各种信息资源的低利用率与低安全性问题。更有甚者，耽误大量的宝贵时间，尤其是对信息的更新，归纳与统计更是耗财耗力的过程。所以电子化信息管理的出现就能缓解以及改变传统人工方式面临的处境，一方面可以确保信息数据在短时间被高效处理，还能节省人力成本，另一方面可以确保信息数据的安全性，可靠性，并可以实现信息数据的快速检索与修改操作，这些优点是之前的旧操作模式无法比拟的。因此孩童收养信息管理为数据信息的管理模式的升级与改革提供了重要的窗口。
## 1.3 论文结构安排
...
# 4 系统设计
## 4.1 总体功能
孩童收养信息管理是根据需求定制开发，开发软件选用Myeclipse平台配合MySQL数据库进行开发环境的搭建操作，网站采用WEB应用程序中最流行的B/S结构进行开发，用户访问系统数据仅仅需要在客户端安装谷歌浏览器或者是当下常用浏览器就可以访问网站内容。
## 4.2 系统概要设计
...
![C:\Users\Administrator\Desktop\img\haitongshouyang\收养者配偶.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\haitongshouyang\收养者配偶.jpg")
图4.1 收养者配偶实体属性图

（2）下图是员工实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\haitongshouyang\员工.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\haitongshouyang\员工.jpg")
图4.2 员工实体属性图

（3）下图是收养实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\haitongshouyang\收养.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\haitongshouyang\收养.jpg")
图4.3 收养实体属性图

（4）下图是送养实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\haitongshouyang\送养.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\haitongshouyang\送养.jpg")
图4.4 送养实体属性图

（5）下图是收养信息更改记录实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\haitongshouyang\收养信息更改记录.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\haitongshouyang\收养信息更改记录.jpg")
图4.5 收养信息更改记录实体属性图
### 4.4.2 数据库表结构设计
...
|3|shouyang\_uuid\_number|String|收养编号|是|
|4|shouyangren\_name|String|收养人姓名|是|
|5|shouyangren\_phone|String|收养人手机号|是|
|6|shouyangren\_guoji|String|收养人国籍|是|
|7|shouyang\_sex\_types|Integer|送养者性别|是|
|8|shouyangren\_chushengnianyue|String|收养人出生年月|是|
|9|shouyangren\_id\_number|String|收养人身份证号|是|
|10|shouyangren\_xianzhuzhi|String|现住址|是|
|11|shouyangren\_nengliqingkuang\_file|String|收养人能力情况证明文件|是|
|12|shouyangren\_shenfenzheng\_photo|String|收养人身份证照片|是|
|13|shouyangren\_jiankangjianchazhengming\_file|String|健康检查证明文件|是|
|14|shouyangren\_hukoubu\_file|String|居民户口簿文件|是|
|15|shouyang\_types|Integer|收养类型|是|
|16|beishouyang\_name|String|被收养者姓名|是|
|17|beishouyang\_photo|String|被收养者照片|是|
|18|beishouyang\_sex\_types|Integer|被收养者性别|是|
|19|beishouyang\_age|String|被收养者年龄|是|
|20|beishouyang\_id\_number|String|被收养人身份证号|是|
|21|beishouyang\_time|Date|收养时间|是|
|22|insert\_time|Date|记录时间|是|
...
|1|Id|Int|id|否|
|2|yuangong\_id|Integer|员工|是|
|3|shouyang\_id|Integer|收养|是|
|4|xiugaiqian\_text|String|修改前|是|
|5|xiugaihou\_text|String|修改后|是|
|6|insert\_time|Date|修改时间|是|
...
|2|yuangong\_id|Integer|员工|是|
|3|shouyang\_id|Integer|收养|是|
|4|shouyang\_peiouren\_name|String|收养者配偶姓名|是|
|5|shouyang\_peiouren\_phone|String|收养者配偶手机号|是|
|6|shouyang\_peiouren\_guoji|String|收养者配偶国籍|是|
|7|shouyang\_peiouren\_age|String|收养者配偶年龄|是|
|8|shouyang\_peiouren\_sex\_types|Integer|收养者配偶性别|是|
|9|shouyang\_peiouren\_chushengnianyue|String|收养者配偶出生年月|是|
|10|shouyang\_peiouren\_id\_number|String|收养者配偶身份证号|是|
|11|shouyang\_peiouren\_xianzhuzhi|String|现住址|是|
|12|shouyang\_peiouren\_shenfenzheng\_photo|String|收养者配偶身份证照片|是|
|13|insert\_time|Date|记录时间|是|
...
|1|Id|Int|id|否|
|2|yuangong\_id|Integer|员工|是|
|3|songyang\_uuid\_number|String|送养编号|是|
|4|songyangren\_name|String|送养人姓名|是|
|5|songyangren\_phone|String|送养人手机号|是|
|6|songyangren\_id\_number|String|送养人身份证号|是|
|7|songyangren\_photo|String|送养人照片|是|
|8|songyang\_sex\_types|Integer|送养者性别|是|
|9|songyangren\_shenfenzheng\_photo|String|送养人身份证照片|是|
|10|songyangren\_yuanshijilu\_file|String|原始记录相关文件|是|
|11|songyangren\_jiguanzhengming\_file|String|机关相关证明文件|是|
|12|songyang\_types|Integer|送养类型|是|
|13|bei\_name|String|被送养者姓名|是|
|14|bei\_photo|String|被送养者照片|是|
|15|bei\_sex\_types|Integer|被送养者性别|是|
|16|bei\_age|String|被送养者年龄|是|
|17|bei\_id\_number|String|被送养者身份证号|是|
|18|bei\_time|Date|送养时间|是|
|19|insert\_time|Date|记录时间|是|
...
|8|yuangong\_email|String|电子邮箱|是|
